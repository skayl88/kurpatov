...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210520_ollaberkana_e6e6f7bff0079eb77697_20210520124236_archive.zip';
	const ARCHIVE_SIZE		 = '49045610';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e6e6f7b-20124236';
    const SECONDARY_PACKAGE_HASH = '52d123e-20124236';
	const VERSION			 = '1.4.0';
